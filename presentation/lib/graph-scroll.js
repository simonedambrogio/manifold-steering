function graphScroll() {
  var windowHeight,
      ...
      eventId = Math.random(),
      stickyTop,
      offset = 180   // distance (px) from viewport top to the activation line
  ...
  function reposition(){
    ...
    if (i != i1){
      ...
      dispatch.call("active", null, i1, i)
  ...
  // d3 v5 compatibility: d3.rebind was removed in d3 v4, so wire `on` manually.
  rv.on = function(){
...
// Expose on the d3 namespace, matching the `d3.graphScroll()` calling convention.
if (typeof d3 !== 'undefined') d3.graphScroll = graphScroll